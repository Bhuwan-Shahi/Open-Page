...
import { isValidEmail, getOTPExpiration } from '@/lib/auth';
...
export async function POST(request) {
  try {
    ...
    // 1. Always require OTP for login
    // 2. Skip OTP for verified users
    // Let's skip OTP for now and directly login verified users
